...
typedef struct
{
    int32_t min;                       /**< Minimum simulated value. */
    int32_t max;                       /**< Maximum simulated value. */
    int32_t incr;                      /**< Increment between each measurement. */
...
typedef struct
{
    int32_t current_val;               /**< Current sensor value. */
 ...
 */
int32_t sensorsim_measure(sensorsim_state_t *     p_state,
                               const sensorsim_cfg_t * p_cfg);
